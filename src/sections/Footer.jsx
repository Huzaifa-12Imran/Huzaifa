                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                    <div>
                        ...
                        <p className="text-[10px] text-grey-mid uppercase tracking-widest mt-2 overflow-hidden">
                            © {currentYear} — Crafted for Excellence
                        </p>
                    </div>
                    ...
                    <div className="flex gap-12">
                        ...
                        <div className="space-y-4">
                            ...
                            <nav className="flex flex-col gap-2">
                                <a href="https://github.com/Huzaifa-12Imran" target="_blank" rel="noopener noreferrer" className="text-xs font-bold uppercase hover:text-gold transition-colors text-grey-deep">GitHub</a>
                                <a href="https://www.linkedin.com/in/huzaifa-imran-12b10b3b3/" target="_blank" rel="noopener noreferrer" className="text-xs font-bold uppercase hover:text-gold transition-colors text-grey-deep">LinkedIn</a>
                                <a href="mailto:sungpog89@gmail.com" className="text-xs font-bold uppercase hover:text-gold transition-colors text-grey-deep">Email</a>
                            </nav>
                        </div>
                    </div>
                </div>
