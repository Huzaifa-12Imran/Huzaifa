...
const skills = [
    {
        name: 'React',
        category: 'Frontend',
        description: 'Building dynamic UIs with component-driven architecture',
        year: '2022',
    },
    {
        name: 'Node.js',
    ...
    },
    {
        name: 'MongoDB',
        category: 'Database',
        description: 'NoSQL document storage for flexible data modeling',
        year: '2023',
    },
    {
        name: 'Express',
        category: 'Backend',
        description: 'Minimal web framework powering RESTful APIs',
        year: '2023',
    },
    {
        name: 'JavaScript',
        category: 'Language',
        description: 'The language of the modern web — ES2024 & beyond',
        year: '2021',
    },
    {
        name: 'Unreal Engine 5',
        category: 'Real-Time 3D',
        description: 'High-fidelity environments with Nanite & Lumen',
        year: '2023',
    },
    {
        name: 'C++',
        category: 'Language',
        description: 'Systems-level performance where precision matters',
        year: '2023',
    },
];
                ...
                <div ref={headerRef} className="flex flex-col md:flex-row justify-between items-end mb-16 md:mb-20">
                    ...
                    <div className="mt-8 md:mt-0">
                        <p className="text-grey-mid max-w-xs md:text-right italic font-inter text-sm leading-relaxed">
                            Exploring the intersection of web logic<br className="hidden md:block" /> and real-time visualization.
                        </p>
