                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-4 w-full">
                    ...
                    <div className="flex flex-col items-start lg:max-w-[70%] w-full">
                        ...
                        >
                            ...
                            <span className="block text-grey-deep">LEGENDS</span>
                        </h1>
                        ...
                        <p className="hero-desc text-grey-mid text-base lg:text-lg leading-relaxed font-medium max-w-md mb-10 opacity-0">
                            Crafting high-fidelity immersive experiences at the intersection of{' '}
                            <span className="text-gold-dark font-semibold">design and engineering</span>.
                            Specialising in high-performance web applications and reality platforms.
                        </p>
